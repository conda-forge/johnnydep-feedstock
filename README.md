...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/johnnydep-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11433&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/johnnydep-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `johnnydep` can be installed with:

```
conda install johnnydep
```

It is possible to list all of the versions of `johnnydep` available on your platform with:
